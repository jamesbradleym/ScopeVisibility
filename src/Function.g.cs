...
namespace ScopeVisibility
{
    public class Function
    {
        ...
        private UrlModelStore<ScopeVisibilityInputs> store;

        public async Task<ScopeVisibilityOutputs> Handler(ScopeVisibilityInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<ScopeVisibilityInputs>();
            }
            

            var l = new InvocationWrapper<ScopeVisibilityInputs,ScopeVisibilityOutputs> (store, ScopeVisibility.Execute);
